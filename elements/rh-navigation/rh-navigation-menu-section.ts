...
import styles from './rh-navigation-menu-section.css';
...
**/
@customElement('rh-navigation-menu-section')
export class RhNavigationMenuSection extends LitElement {
    ...
    for (const list of lists) {
      if (!list.hasAttribute('aria-labelledby')) {
        ...
        if (!header) {
          ...
          header.id ||= getRandomId('rh-navigation-menu-section');
...
declare global {
  interface HTMLElementTagNameMap {
    'rh-navigation-menu-section': RhNavigationMenuSection;
  }
}
